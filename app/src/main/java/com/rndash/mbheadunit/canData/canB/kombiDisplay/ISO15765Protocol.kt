...
class ISO15765Protocol(private val byteBuffer: Array<Byte>, private val sendID: Int, private val recvID: Int) {
    var seperation_time_ms = 0L // Seperation time between sending multi frames
    private val totalSize = byteBuffer.size
    private var sentBytes = 0
    private var isSending = false
    private var sendComplete = false
    private var startID: Int = 0x10
    fun sendBuffer() {
    ...
    private fun threadedSend() {
        ...
        println("Sending multiple frames complete!")
        sendComplete = true
    }
