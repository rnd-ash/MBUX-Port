...
object SAM_H_A3 {
    ...
    **/
	...
	fun set_warn_akt(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_bli_li_ein(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_bli_re_ein(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_hell_blink(f: CanFrame, p: Int) : CanFrame? {
		checkFrame(f)
