...
object EZS_A1 {
    ...
    **/
	...
	fun set_kl_15c_ein(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_kl_15r_ein(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_kl_15_ein(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_kl_15x_ein(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_kl_50_ein(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_fern_alarm(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_pnk_alm_ein(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_pnk_alm_aus(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_appl_aus(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_diag_tgl(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_fzg_rech(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_spei_nr(f: CanFrame, p: SPEI_NR) : CanFrame? {
		checkFrame(f)
	...
	fun set_hd_stopp(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_zv_spiel(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_zv_passiv(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_schlue_neu(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_bli_entsi(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_bli_sich(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_auss_entsi(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_auss_sich(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_schl_bef(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_zv_nv(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_td_entri(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_td_verri(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_hd_entsi(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_hd_sich(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_hfe_ezs(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_tvl_entri(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_tvl_verri(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_tvr_entri(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_tvr_verri(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_thl_entri(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_thl_verri(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_thr_entri(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_thr_verri(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
