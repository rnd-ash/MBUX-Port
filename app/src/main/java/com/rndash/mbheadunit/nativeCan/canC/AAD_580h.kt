...
object AAD_580h {
	...
	fun set_ftk_bmi(f: CanFrame, p: Int) = CanBusNative.setFrameParameter(f, 0, 8, p)
	...
	fun set_ftk_lmi(f: CanFrame, p: Int) = CanBusNative.setFrameParameter(f, 8, 8, p)
	...
	fun set_ftk_vmi(f: CanFrame, p: Int) = CanBusNative.setFrameParameter(f, 16, 8, p)
	...
	fun set_ftk_dpw(f: CanFrame, p: Int) = CanBusNative.setFrameParameter(f, 32, 8, p)
	...
	fun set_aadkb(f: CanFrame, p: Int) = CanBusNative.setFrameParameter(f, 40, 8, p)
	...
	fun set_aadkbdyn(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 48, 1, if(p) 1 else 0)
	
	/** Gets Nervousness **/
	fun get_aadnt() : Int = CanBusNative.getECUParameterC(CanCAddrs.AAD_580h, 56, 8)
	
	/** Sets Nervousness **/
	fun set_aadnt(f: CanFrame, p: Int) = CanBusNative.setFrameParameter(f, 56, 8, p)
