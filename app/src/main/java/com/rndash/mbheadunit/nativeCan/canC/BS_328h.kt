...
object BS_328h {
    ...
    **/
	...
	fun set_wms_pa(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_wms(f: CanFrame, p: Int) {
		checkFrame(f)
		CanBusNative.setFrameParameter(f, 1, 15, p)
	}
	...
	fun set_esp_dspl(f: CanFrame, p: ESP_DSPL) {
		checkFrame(f)
		CanBusNative.setFrameParameter(f, 35, 5, p.raw)
	}
	...
	fun set_bz328h(f: CanFrame, p: Int) {
		checkFrame(f)
		CanBusNative.setFrameParameter(f, 45, 3, p)
	}
	...
	/** Sets open clutch **/
	fun set_kpl_oef(f: CanFrame, p: Boolean) {
		checkFrame(f)
