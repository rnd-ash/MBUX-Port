...
object MS_268h {
    ...
    **/
	...
	fun set_imin_ms(f: CanFrame, p: Int) {
		checkFrame(f)
	...
	fun set_imax_ms(f: CanFrame, p: Int) {
		checkFrame(f)
	...
	fun set_hzl_st(f: CanFrame, p: HZL_ST) {
		checkFrame(f)
		CanBusNative.setFrameParameter(f, 22, 2, p.raw)
	}
	...
	fun set_asv_kkl_169(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_oel_info_169(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_last_gen(f: CanFrame, p: Int) {
		checkFrame(f)
		CanBusNative.setFrameParameter(f, 26, 6, p)
	}
	...
	fun set_lrs_mode(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_kid_ms(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m_komp_max(f: CanFrame, p: Int) {
		checkFrame(f)
