...
object SAM_V_A4 {
    ...
    **/
	...
	fun set_sp_n_li(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sp_n_re(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sp_n_ob(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sp_n_un(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sp_garage(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sp_fahren(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_spvs_st(f: CanFrame, p: Boolean) {
		checkFrame(f)
