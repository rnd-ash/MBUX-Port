...
object TVL_A1 {
	...
	fun set_svl_vor(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 7, 1, if(p) 1 else 0)
	
	/** Gets seat front left **/
	fun get_svl_zur() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 6, 1) != 0
	
	/** Sets seat front left **/
	fun set_svl_zur(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 6, 1, if(p) 1 else 0)
	
	/** Gets seat front left **/
	fun get_svl_hi_auf() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 5, 1) != 0
	
	/** Sets seat front left **/
	fun set_svl_hi_auf(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 5, 1, if(p) 1 else 0)
	
	/** Gets seat front left **/
	fun get_svl_hi_ab() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 4, 1) != 0
	
	/** Sets seat front left **/
	fun set_svl_hi_ab(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 4, 1, if(p) 1 else 0)
	
	/** Gets front left seat **/
	fun get_svl_tgl() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 0, 1) != 0
	
	/** Sets front left seat **/
	fun set_svl_tgl(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 0, 1, if(p) 1 else 0)
	
	/** Gets front left seat **/
	fun get_svl_le_vor() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 13, 1) != 0
	
	/** Sets front left seat **/
	fun set_svl_le_vor(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 13, 1, if(p) 1 else 0)
	
	/** Gets front left seat **/
	fun get_svl_le_zur() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 12, 1) != 0
	
	/** Sets front left seat **/
	fun set_svl_le_zur(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 12, 1, if(p) 1 else 0)
	
	/** Gets seat front left **/
	fun get_svl_vo_auf() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 11, 1) != 0
	
	/** Sets seat front left **/
	fun set_svl_vo_auf(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 11, 1, if(p) 1 else 0)
	
	/** Gets seat front left **/
	fun get_svl_vo_ab() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 10, 1) != 0
	
	/** Sets seat front left **/
	fun set_svl_vo_ab(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 10, 1, if(p) 1 else 0)
	
	/** Gets front left seat **/
	fun get_svl_kst_auf() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 9, 1) != 0
	
	/** Sets front left seat **/
	fun set_svl_kst_auf(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 9, 1, if(p) 1 else 0)
	
	/** Gets front left seat **/
	fun get_svl_kst_ab() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 8, 1) != 0
	
	/** Sets front left seat **/
	fun set_svl_kst_ab(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 8, 1, if(p) 1 else 0)
	...
	fun set_ls_auf_ll(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 19, 1, if(p) 1 else 0)
	...
	fun set_ls_ab_ll(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 18, 1, if(p) 1 else 0)
	...
	fun set_ls_vor_ll(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 17, 1, if(p) 1 else 0)
	...
	fun set_ls_zurueck_ll(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 16, 1, if(p) 1 else 0)
	...
	fun set_mvl_p1_en(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 31, 1, if(p) 1 else 0)
	
	/** Gets memory front left **/
	fun get_mvl_p2_en() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 30, 1) != 0
	
	/** Sets memory front left **/
	fun set_mvl_p2_en(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 30, 1, if(p) 1 else 0)
	
	/** Gets memory front left **/
	fun get_mvl_p3_en() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 29, 1) != 0
	
	/** Sets memory front left **/
	fun set_mvl_p3_en(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 29, 1, if(p) 1 else 0)
	...
	fun set_mvl_p1_sp(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 28, 1, if(p) 1 else 0)
	
	/** Gets memory front left **/
	fun get_mvl_p2_sp() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 27, 1) != 0
	
	/** Sets memory front left **/
	fun set_mvl_p2_sp(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 27, 1, if(p) 1 else 0)
	
	/** Gets memory front left **/
	fun get_mvl_p3_sp() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 26, 1) != 0
	
	/** Sets memory front left **/
	fun set_mvl_p3_sp(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 26, 1, if(p) 1 else 0)
	...
	fun set_spi_re_sp(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 25, 1, if(p) 1 else 0)
	
	/** Gets front left memory **/
	fun get_mvl_tgl() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A1, 24, 1) != 0
	
	/** Sets front left memory **/
	fun set_mvl_tgl(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 24, 1, if(p) 1 else 0)
	...
	fun set_spi_re_n_li(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 39, 1, if(p) 1 else 0)
	...
	fun set_spi_re_n_re(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 38, 1, if(p) 1 else 0)
	...
	fun set_spi_re_n_ob(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 37, 1, if(p) 1 else 0)
	...
	fun set_spi_re_n_un(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 36, 1, if(p) 1 else 0)
	...
	fun set_spi_re_garage(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 35, 1, if(p) 1 else 0)
	...
	fun set_spi_re_fahren(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 34, 1, if(p) 1 else 0)
	...
	fun set_spvs_bet_ll(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 32, 1, if(p) 1 else 0)
