...
object ARMADA_A1 {
	...
	fun set_srs_werk(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 7, 1, if(p) 1 else 0)
	...
	fun set_srs_serv(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 6, 1, if(p) 1 else 0)
	...
	fun set_srs_blink(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 5, 1, if(p) 1 else 0)
	
	/** Gets SRS control lamp **/
	fun get_srs_kl() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.ARMADA_A1, 4, 1) != 0
	
	/** Sets SRS control lamp **/
	fun set_srs_kl(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 4, 1, if(p) 1 else 0)
	...
	fun set_akse_blink(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 1, 1, if(p) 1 else 0)
	...
	fun set_akse_ein(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 0, 1, if(p) 1 else 0)
	...
	fun set_kisi_st(f: CanFrame, p: KISI_ST) = CanBusNative.setFrameParameter(f, 13, 3, p.raw)
	...
	fun set_sbe_bf(f: CanFrame, p: SBE_BF) = CanBusNative.setFrameParameter(f, 21, 3, p.raw)
	...
	fun set_psg_detec_fast(f: CanFrame, p: PSG_DETEC_FAST) = CanBusNative.setFrameParameter(f, 19, 2, p.raw)
	...
	fun set_gs_bf(f: CanFrame, p: GS_BF) = CanBusNative.setFrameParameter(f, 16, 2, p.raw)
	...
	fun set_sbe_f(f: CanFrame, p: SBE_F) = CanBusNative.setFrameParameter(f, 29, 3, p.raw)
	...
	fun set_gs_f(f: CanFrame, p: GS_F) = CanBusNative.setFrameParameter(f, 24, 2, p.raw)
