...
object SAM_V_A3 {
	...
	fun set_rs_akt(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 7, 1, if(p) 1 else 0)
	...
	fun set_kl_31b_ein(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 6, 1, if(p) 1 else 0)
	...
	fun set_kl_86_ein(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 5, 1, if(p) 1 else 0)
	...
	fun set_konfig_rs(f: CanFrame, p: KONFIG_RS) = CanBusNative.setFrameParameter(f, 2, 3, p.raw)
	...
	fun set_parity_sam_v(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 0, 1, if(p) 1 else 0)
	...
	fun set_rs_int(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 15, 1, if(p) 1 else 0)
	...
	fun set_kl_31b_rs(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 14, 1, if(p) 1 else 0)
	
	/** Gets washing activated **/
	fun get_kl_86_rs() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.SAM_V_A3, 13, 1) != 0
	
	/** Sets washing activated **/
	fun set_kl_86_rs(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 13, 1, if(p) 1 else 0)
	...
	fun set_sam_v_init(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 12, 1, if(p) 1 else 0)
	...
	fun set_rs_nm(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 11, 1, if(p) 1 else 0)
	...
	fun set_diag_rs(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 10, 1, if(p) 1 else 0)
	
	/** Gets byte identifier **/
	fun get_byte_kenn() : Int = CanBusNative.getECUParameterB(CanBAddrs.SAM_V_A3, 8, 2)
	
	/** Sets byte identifier **/
	fun set_byte_kenn(f: CanFrame, p: Int) = CanBusNative.setFrameParameter(f, 8, 2, p)
