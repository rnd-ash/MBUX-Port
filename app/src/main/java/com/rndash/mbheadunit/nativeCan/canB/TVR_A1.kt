...
object TVR_A1 {
    ...
    **/
	...
	fun set_svr_vor(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets seat front right **/
	fun set_svr_zur(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets seat front right **/
	fun set_svr_hi_auf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets seat front right **/
	fun set_svr_hi_ab(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_svr_tgl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets seat front right **/
	fun set_svr_le_vor(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets front right seat **/
	fun set_svr_le_zur(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets seat front right **/
	fun set_svr_vo_auf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_svr_vo_ab(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets front right seat **/
	fun set_svr_kst_auf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets front right seat **/
	fun set_svr_kst_ab(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_ls_auf_rl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_ls_ab_rl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_ls_vor_rl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_ls_zurueck_rl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mvr_p1_en(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets memory front right **/
	fun set_mvr_p2_en(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets memory front right **/
	fun set_mvr_p3_en(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mvr_p1_sp(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets memory front right **/
	fun set_mvr_p2_sp(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets memory front right **/
	fun set_mvr_p3_sp(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_spi_li_sp(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets front right memory **/
	fun set_mvr_tgl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_spi_li_n_li(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_spi_li_n_re(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_spi_li_n_ob(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_spi_li_n_un(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_spi_li_garage(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_spi_li_fahren(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_spvs_bet_rl(f: CanFrame, p: Boolean) {
		checkFrame(f)
