...
object GS_218h {
    ...
    **/
	...
	fun set_mmax_egs(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mmin_egs(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mtgl_egs(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m_egs(f: CanFrame, p: Int) {
		checkFrame(f)
	...
	fun set_hsm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fw_hoch(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_gsp_ok(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets off-road gear **/
	fun set_g_g(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_k_g_b(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_k_o_b(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_k_s_b(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fpc_aad(f: CanFrame, p: FPC_AAD) {
		checkFrame(f)
	...
	fun set_uehitz_get(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_gs_notl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets start release **/
	fun set_alf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets bang start **/
	fun set_ks(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets gear ok **/
	fun set_get_ok(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mot_naus(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mot_naus_cnf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_k_lstfr(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_dyn0_amr_egs(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets intervention mode / drive torque control **/
	fun set_dyn1_egs(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mpar_egs(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mkriech(f: CanFrame, p: Int) {
		checkFrame(f)
	...
	fun set_error(f: CanFrame, p: Int) {
		checkFrame(f)
		CanBusNative.setFrameParameter(f, 59, 5, p)
	}
	...
	fun set_calid_cvn_akt(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fehlprf_st(f: CanFrame, p: FEHLPRF_ST) {
		checkFrame(f)
		CanBusNative.setFrameParameter(f, 56, 2, p.raw)
	}
