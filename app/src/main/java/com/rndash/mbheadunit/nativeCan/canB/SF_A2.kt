...
object SF_A2 {
    ...
    **/
	...
	fun set_esh_auto_rest(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_mf_man_sp(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_auto_akt(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_esh_akt(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
