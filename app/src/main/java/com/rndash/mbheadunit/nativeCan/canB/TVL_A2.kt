...
object TVL_A2 {
	...
	fun set_kb_mod_tvl(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 14, 1, if(p) 1 else 0)
	...
	fun set_kb_ri_tvl(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 13, 1, if(p) 1 else 0)
	...
	fun set_shd_tvl(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 12, 1, if(p) 1 else 0)
	...
	fun set_fvl_tvl(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 11, 1, if(p) 1 else 0)
	...
	fun set_fvr_tvl(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 10, 1, if(p) 1 else 0)
	...
	fun set_fhl_tvl(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 9, 1, if(p) 1 else 0)
	...
	fun set_fhr_tvl(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 8, 1, if(p) 1 else 0)
	...
	fun set_fhl_aoe_ll(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 23, 1, if(p) 1 else 0)
	
	/** Gets rear left window **/
	fun get_fhl_moe_ll() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A2, 22, 1) != 0
	
	/** Sets rear left window **/
	fun set_fhl_moe_ll(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 22, 1, if(p) 1 else 0)
	
	/** Gets rear left window **/
	fun get_fhl_ms_ll() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A2, 21, 1) != 0
	
	/** Sets rear left window **/
	fun set_fhl_ms_ll(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 21, 1, if(p) 1 else 0)
	
	/** Gets rear left window **/
	fun get_fhl_as_ll() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A2, 20, 1) != 0
	
	/** Sets rear left window **/
	fun set_fhl_as_ll(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 20, 1, if(p) 1 else 0)
	...
	fun set_fhr_aoe_ll(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 19, 1, if(p) 1 else 0)
	
	/** Gets rear right window **/
	fun get_fhr_moe_ll() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A2, 18, 1) != 0
	
	/** Sets rear right window **/
	fun set_fhr_moe_ll(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 18, 1, if(p) 1 else 0)
	
	/** Gets rear right window **/
	fun get_fhr_ms_ll() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A2, 17, 1) != 0
	
	/** Sets rear right window **/
	fun set_fhr_ms_ll(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 17, 1, if(p) 1 else 0)
	
	/** Gets rear right window **/
	fun get_fhr_as_ll() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A2, 16, 1) != 0
	
	/** Sets rear right window **/
	fun set_fhr_as_ll(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 16, 1, if(p) 1 else 0)
	...
	fun set_fvr_aoe(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 27, 1, if(p) 1 else 0)
	...
	fun set_fvr_moe(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 26, 1, if(p) 1 else 0)
	...
	fun set_fvr_ms(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 25, 1, if(p) 1 else 0)
	
	/** Gets window front right **/
	fun get_fvr_as() : Boolean = CanBusNative.getECUParameterB(CanBAddrs.TVL_A2, 24, 1) != 0
	
	/** Sets window front right **/
	fun set_fvr_as(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 24, 1, if(p) 1 else 0)
