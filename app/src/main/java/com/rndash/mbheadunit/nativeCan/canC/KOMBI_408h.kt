...
object KOMBI_408h {
	...
	/** Sets tank level **/
	fun set_tank_fs(f: CanFrame, p: Int) = CanBusNative.setFrameParameter(f, 0, 8, p)
	...
	fun set_kl_61e(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 15, 1, if(p) 1 else 0)
	...
	fun set_tfsm(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 14, 1, if(p) 1 else 0)
	...
	fun set_vgl_kl_def(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 13, 1, if(p) 1 else 0)
	...
	fun set_kla_vh(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 12, 1, if(p) 1 else 0)
	...
	fun set_v_mph(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 11, 1, if(p) 1 else 0)
	...
	fun set_tacho_sym(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 10, 1, if(p) 1 else 0)
	...
	fun set_v_dspl_aus(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 9, 1, if(p) 1 else 0)
	...
	fun set_tf_auf(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 8, 1, if(p) 1 else 0)
	...
	fun set_t_aussen(f: CanFrame, p: Int) = CanBusNative.setFrameParameter(f, 16, 8, p)
	
	/** Gets Terminal 58 dimmed **/
	fun get_kl_58d() : Int = CanBusNative.getECUParameterC(CanCAddrs.KOMBI_408h, 24, 8)
	
	/** Sets Terminal 58 dimmed **/
	fun set_kl_58d(f: CanFrame, p: Int) = CanBusNative.setFrameParameter(f, 24, 8, p)
	...
	fun set_maz(f: CanFrame, p: Int) = CanBusNative.setFrameParameter(f, 32, 8, p)
	
	/** Gets mileage **/
	fun get_km16() : Int = CanBusNative.getECUParameterC(CanCAddrs.KOMBI_408h, 40, 16)
	
	/** Sets mileage **/
	fun set_km16(f: CanFrame, p: Int) = CanBusNative.setFrameParameter(f, 40, 16, p)
	...
	fun set_wrc(f: CanFrame, p: WRC) = CanBusNative.setFrameParameter(f, 61, 3, p.raw)
	...
	fun set_rt_ein(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 60, 1, if(p) 1 else 0)
	...
	fun set_zh_freig(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 59, 1, if(p) 1 else 0)
	...
	fun set_sgt_vh(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 58, 1, if(p) 1 else 0)
	...
	fun set_v_dspl_akt(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 57, 1, if(p) 1 else 0)
	...
	fun set_wrc3(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 56, 1, if(p) 1 else 0)
