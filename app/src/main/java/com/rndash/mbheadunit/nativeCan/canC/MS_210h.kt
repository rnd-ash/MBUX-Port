...
object MS_210h {
    ...
    **/
	...
	fun set_anf1(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_creep_aus(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_slv_ms(f: CanFrame, p: SLV_MS) {
		checkFrame(f)
		CanBusNative.setFrameParameter(f, 1, 4, p.raw)
	}
	...
	fun set_gmin_ms(f: CanFrame, p: GMIN_MS) {
		checkFrame(f)
	...
	fun set_gmax_ms(f: CanFrame, p: GMAX_MS) {
		checkFrame(f)
	...
	fun set_zh_aus_ms(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_akt_r_ms(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_crash_ms(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mss_akt(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mss_kl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mss_def(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vgl_st(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_v_dspl_neu(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_v_max_sum(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_notl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_kd_ms(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_v_max_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_tm_reg(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_kueb_s_a(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets idle **/
	fun set_ll(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_pwg_err(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_v_dspl_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_v_dspl_bl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_v_dspl_err(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_v_dspl_lim(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_v_max_reg(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_tm_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_v_dspl_pgb(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fbs_se(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fmmotmax(f: CanFrame, p: Int) {
		checkFrame(f)
	...
	fun set_v_max_tm(f: CanFrame, p: Int) {
		checkFrame(f)
