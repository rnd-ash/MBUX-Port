...
object SAM_H_A1 {
    ...
    **/
	...
	fun set_tvl_auf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_tvr_auf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_thl_auf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_thr_auf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hd_auf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hdk_bet(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_pnk_akt(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hd_sk_sam_h(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hschl_zu(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hschl_st_sich(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hhs_st_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hhs_st_uspg(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hvst_f_ent(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hvst_bf_ent(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mot_auf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_edw_alarm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_edw_aag_akt(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_edw_irs_akt(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets EDW sharpened **/
	fun set_edw_akt(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_edw_il_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_kl_54_def(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_bl3_def(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_nsl_def(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_bli_def_hl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sl_def_l(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_bl_def_l(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_rfl_def_l(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_kzl_def_l(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sm_def_hl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sm_def_hr(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_bli_def_hr(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sl_def_r(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_bl_def_r(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_rfl_def_r(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_kzl_def_r(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_bli_ers_hl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sl_ers_hl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_bli_ers_hr(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sl_ers_hr(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_nsl_ers(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hd_sich_sam_h(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hd_schliess_sam_h(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hfs_sb_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_srs_kl_hw(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_gurt_kl_hw(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hw_int_akt(f: CanFrame, p: Boolean) {
		checkFrame(f)
