...
object MRM_A2 {
    ...
    **/
	...
	fun set_wippe_1_1(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_wippe_1_2(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_wippe_2_1(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_wippe_2_2(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_wippe_3_1(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_wippe_3_2(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_wippe_4_1(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_wippe_4_2(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets reserve **/
	fun set_wippe_5_1(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets reserve **/
	fun set_wippe_5_2(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets reserve **/
	fun set_wippe_6_1(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets reserve **/
	fun set_wippe_6_2(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets reserve **/
	fun set_wippe_7_1(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets reserve **/
	fun set_wippe_7_2(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets reserve **/
	fun set_wippe_8_1(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets reserve **/
	fun set_wippe_8_2(f: CanFrame, p: Boolean) {
		checkFrame(f)
