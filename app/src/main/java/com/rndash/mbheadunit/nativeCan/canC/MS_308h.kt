...
object MS_308h {
    ...
    **/
	...
	fun set_zasbed(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_wks_kl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_ksf_kl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sasv(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sast(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_n_max_bg(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_kueb_o_a(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_tank_kl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vgl_kl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_lufi_kl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_eoh(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_elhp_warn(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_temp_kl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_dbaa(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_anl_lft(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_adr_def_kl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_adr_kl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_zas(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_t_oel(f: CanFrame, p: Int) {
		checkFrame(f)
	...
	/** Sets oil level **/
	fun set_oel_fs(f: CanFrame, p: Int) {
		checkFrame(f)
	...
	/** Sets oil quality **/
	fun set_oel_qual(f: CanFrame, p: Int) {
		checkFrame(f)
