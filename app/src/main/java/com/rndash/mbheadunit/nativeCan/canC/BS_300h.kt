...
object BS_300h {
    ...
    **/
	...
	fun set_lws_ini_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_lws_ini_ok(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_esp_gier_akt(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets Enable ART **/
	fun set_art_e(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vollbre(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_bas_akt(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_dmdyn_art(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_dmpar_art(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sfb_pa(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_t_z(f: CanFrame, p: T_Z) {
		checkFrame(f)
		CanBusNative.setFrameParameter(f, 11, 2, p.raw)
	}
	...
	fun set_amr_akt_esp(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mdyn_esp(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets Motor torque request parity (even parity) **/
	fun set_mpar_esp(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_dmmax_art(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_dmmin_art(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_dmtgl_art(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_dm_art(f: CanFrame, p: Int) {
		checkFrame(f)
	...
	/** Sets Motor torque request Max **/
	fun set_mmax_esp(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mmin_esp(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mtgl_esp(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets Required. Engine torque **/
	fun set_m_esp(f: CanFrame, p: Int) {
		checkFrame(f)
	...
	fun set_gier_roh(f: CanFrame, p: Int) {
		checkFrame(f)
