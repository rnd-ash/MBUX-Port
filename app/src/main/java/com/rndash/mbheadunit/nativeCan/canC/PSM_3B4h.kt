...
object PSM_3B4h {
    ...
    **/
	...
	fun set_psm_adr_akt(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_psm_adr_tgl(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	/** Sets working speed control **/
	fun set_psm_adr_par(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_psm_n_soll(f: CanFrame, p: Int) : CanFrame? {
		checkFrame(f)
	...
	fun set_psm_mom_akt(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	/** Sets torque limit **/
	fun set_psm_mom_tgl(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_psm_mom_par(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_psm_mom_soll(f: CanFrame, p: Int) : CanFrame? {
		checkFrame(f)
		return CanBusNative.setFrameParameter(f, 27, 13, p)
	}
	...
	fun set_psm_dz_akt(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_psm_dz_tgl(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	/** Sets speed limitation **/
	fun set_psm_dz_par(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	/** Sets maximum speed **/
	fun set_psm_dz_max(f: CanFrame, p: Int) : CanFrame? {
		checkFrame(f)
