...
object OBF_A1 {
    ...
    **/
	...
	fun set_fks_bet(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hr_bet(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_zv_entri_is(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_zv_verri_is(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_edw_hand_auf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_edw_irs_abw(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_edw_as_abw(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_wbl_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_pts_bet(f: CanFrame, p: Boolean) {
		checkFrame(f)
