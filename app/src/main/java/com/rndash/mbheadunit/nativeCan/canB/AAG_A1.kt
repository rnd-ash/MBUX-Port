...
object AAG_A1 {
    ...
    **/
	...
	fun set_anhbl_def(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_edw_anh_alm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_anhkl_54_def(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_ahk_nok(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_anh_erk(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_anhbli_def_r(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_anhsl_def_r(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_anhbli_def_l(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_anhsl_def_l(f: CanFrame, p: Boolean) {
		checkFrame(f)
