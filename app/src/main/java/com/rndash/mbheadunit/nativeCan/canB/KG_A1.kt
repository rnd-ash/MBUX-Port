...
object KG_A1 {
    ...
    **/
	...
	fun set_warnton_kg(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m0(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m1(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m2(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m3(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m4(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m5(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m6(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m7(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m8(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m9(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m10(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m11(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_m12(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_km_rest_kg(f: CanFrame, p: Int) {
		checkFrame(f)
