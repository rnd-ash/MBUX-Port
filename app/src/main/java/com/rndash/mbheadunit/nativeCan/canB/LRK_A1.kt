...
object LRK_A1 {
	...
	fun set_lrk_stoerg(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 2, 1, if(p) 1 else 0)
	...
	fun set_lhzg_led_ein(f: CanFrame, p: Boolean) = CanBusNative.setFrameParameter(f, 1, 1, if(p) 1 else 0)
