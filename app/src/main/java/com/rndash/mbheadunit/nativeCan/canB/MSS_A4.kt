...
object MSS_A4 {
    ...
    **/
	...
	fun set_mod_alarm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_ri_alarm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets SHD close **/
	fun set_shd_alarm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fvl_alarm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fvr_alarm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fhl_alarm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fhr_alarm(f: CanFrame, p: Boolean) {
		checkFrame(f)
