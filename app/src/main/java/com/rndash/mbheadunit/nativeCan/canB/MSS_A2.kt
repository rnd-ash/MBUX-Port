...
object MSS_A2 {
    ...
    **/
	...
	fun set_mss_ee_def(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_notalm_def(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mss_alm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mss_uspg(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_dz_def(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_dz_prf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_dz_la_def(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_dz_kl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_np_leer(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_nebel_akt(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_nebel_aus(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_o2_leer(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_o2_akt(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_o2_aus(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mss_summer(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets radio status **/
	fun set_fnk_stat(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_mss_uspg_mo(f: CanFrame, p: Boolean) {
		checkFrame(f)
