...
object MRM_A1 {
    ...
    **/
	...
	fun set_fl_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_lhp_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sgh_ein_lr(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_heck_wisch_mrm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_heck_int_mrm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_tipp_wisch(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_washing(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sch_wi_int(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sch_wi_1(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sch_wi_2(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sbs_aus(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_sbs_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_esh_ein_mrm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_ls_st_ver(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_lw_vz_b(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_lw_ini_b(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_lw_cf_b(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_lw_ov_b(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_lw_pa_b(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets Steering angle  **/
	fun set_lw_b(f: CanFrame, p: Int) {
		checkFrame(f)
		CanBusNative.setFrameParameter(f, 29, 11, p)
	}
