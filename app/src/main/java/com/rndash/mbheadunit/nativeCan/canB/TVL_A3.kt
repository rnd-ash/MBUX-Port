...
object TVL_A3 {
    ...
    **/
	...
	fun set_hfs_ll(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_zbll_def(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets child lock on **/
	fun set_kisi_ein_ll(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hfe_ll(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_spvs_bf_ll(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fvl_kzhb(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets window open **/
	fun set_fvl_auf(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fvl_block(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fvl_norm(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_feste_vl(f: CanFrame, p: Int) {
		checkFrame(f)
