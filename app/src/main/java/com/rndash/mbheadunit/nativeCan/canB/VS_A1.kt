...
object VS_A1 {
    ...
    **/
	...
	fun set_vdk_stat(f: CanFrame, p: VDK_STAT) {
		checkFrame(f)
	...
	fun set_vdk_aktiv(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fh_vl_kh(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vdk_warn(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_uerb_kl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hd_sperr(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fh_vr_kh(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m1(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m2(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m3(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m4(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m5(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m6(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m7(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m8(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m9(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m10(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m11(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m12(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m13(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vs_m14(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_hd_sk_vs(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_fhs_v_sperr(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_vdk_kl_anf(f: CanFrame, p: VDK_KL_ANF) {
		checkFrame(f)
