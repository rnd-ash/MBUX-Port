...
object ART_258h {
    ...
    **/
	...
	/** Sets ART error code **/
	fun set_art_err(f: CanFrame, p: ART_ERR) {
		checkFrame(f)
	...
	/** Sets ART info lamp **/
	fun set_art_info(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_art_wt(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_s_obj(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_art_dspl_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets set ART speed **/
	fun set_v_art(f: CanFrame, p: Int) {
		checkFrame(f)
	...
	fun set_abst_r_obj(f: CanFrame, p: Int) {
		checkFrame(f)
	...
	fun set_soll_abst(f: CanFrame, p: Int) {
		checkFrame(f)
	...
	fun set_tm_ein_art(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_art_dspl_bl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_art_seg_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_obj_erk(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_art_ein(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_art_dspl_lim(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_art_vfbr(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_art_dspl_pgb(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_v_ziel(f: CanFrame, p: Int) {
		checkFrame(f)
	...
	fun set_assist_fkt_akt(f: CanFrame, p: ASSIST_FKT_AKT) {
		checkFrame(f)
	...
	fun set_aas_led_bl(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_obj_agb(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_art_reakt(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_art_uebersp(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_art_dspl_neu(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_assist_anz_v2(f: CanFrame, p: ASSIST_ANZ_V2) {
		checkFrame(f)
		CanBusNative.setFrameParameter(f, 59, 5, p.raw)
	}
	...
	fun set_cas_err_anz_v2(f: CanFrame, p: CAS_ERR_ANZ_V2) {
		checkFrame(f)
		CanBusNative.setFrameParameter(f, 56, 3, p.raw)
	}
