...
object ARMADA_A2 {
    ...
    **/
	...
	fun set_crash_a(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets rear event 1 **/
	fun set_crash_b(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets side event 1 **/
	fun set_crash_d(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets rear event 2 **/
	fun set_crash_e(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_crash_g(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_crash_h(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_crash_i(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets rear event 3 **/
	fun set_crash_k(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets side event 2 **/
	fun set_crash_l(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets event tbd **/
	fun set_crash_m(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets event tbd **/
	fun set_crash_n(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	/** Sets event tbd **/
	fun set_crash_o(f: CanFrame, p: Boolean) {
		checkFrame(f)
	...
	fun set_x_crash(f: CanFrame, p: Boolean) {
		checkFrame(f)
