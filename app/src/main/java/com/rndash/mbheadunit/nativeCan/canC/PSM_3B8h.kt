...
object PSM_3B8h {
    ...
    **/
	...
	fun set_psm_v_akt(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	/** Sets speed limit **/
	fun set_psm_v_tgl(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	/** Sets speed limit **/
	fun set_psm_v_par(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	/** Sets speed limit **/
	fun set_psm_v_soll(f: CanFrame, p: Int) : CanFrame? {
		checkFrame(f)
	...
	fun set_psm_fpm_sp(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_psm_fern_stop(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
	...
	fun set_psm_fern_start(f: CanFrame, p: Boolean) : CanFrame? {
		checkFrame(f)
